...
$sourcePath = "c:\Users\Ramoncito\Downloads\traductor-de-se-as-v1-0\dist\assets\img\Alfabeto-Manual-Argentino-LSA-CAS-1086x1536.png"
$outputPath = "c:\Users\Ramoncito\Downloads\traductor-de-se-as-v1-0\dist\assets\alphabet\"

if (!(Test-Path $outputPath)) { New-Item -ItemType Directory -Path $outputPath }

$img = [System.Drawing.Image]::FromFile($sourcePath)

# Configuración de la grilla (ajustada para el póster de 1086x1536)
$startX = 30
$startY = 180
$cellW = 210
$cellH = 205
...
for ($row = 0; $row -lt $alphabet.Length; $row++) {
    for ($col = 0; $col -lt $alphabet[$row].Length; $col++) {
        ...
        # Ajuste fino para algunas letras si es necesario
